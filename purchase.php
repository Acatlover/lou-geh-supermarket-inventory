                        ...
                        <div class="modal-body">                           
                            ...
                            <input type="hidden" name="btn_action" id="btn_action" />
                                <div class="form-group">
                                    ...
                                    <select name="pid" id="pid" class="form-select rounded-0" required>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="unit_price" id="unit_price" class="form-control rounded-0" required pattern="[+-]?([0-9]*[.])?[0-9]+" />
                                </div>
                            </form>
                        </div>
